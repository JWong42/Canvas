class KeyMetricsController < ApplicationController
   ...
   def create
    ...
    if @key_metric.valid?
      ...
      if feed.save
        ...
        data = { canvas_id: @canvas.id, component: 'key_metrics', item_id: @key_metric.id, item_content: @key_metric.content, item_color: @key_metric.tag_color, notification: content, emails: emails, type: 'item-create' }.to_json
  ...
  def update
    ...
    if @key_metric.save
      ...
      if feed.save
        ...
        data = { canvas_id: @canvas.id, component: 'key_metrics', item_id: @key_metric.id, item_color: @key_metric.tag_color, notification: content, emails: emails, type: 'item-update' }.to_json
        redis.publish('feeds', data)
  ...
  def destroy 
    ...
    if feed.save
      ...
      data = { canvas_id: @canvas.id, component: 'key_metrics', item_id: @key_metric.id, notification: content, emails: emails, type: 'item-delete' }.to_json
      redis.publish('feeds', data)
      render json: { text: 'success' }
    end
  end 
